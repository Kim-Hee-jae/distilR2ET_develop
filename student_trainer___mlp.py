...
from src.student_model import DistilRET
...
def main(args):
    ...
    best_val = float("inf")
    if args.resume:
        start_epoch, prev_best = load_model(model, optimizer, args.resume, device)
    ...
    for epoch in range(start_epoch, args.num_epoch):
        ...
        val_loss, val_dqs, val_dqg = eval_one_epoch(epoch, model, val_loader, device, args)
